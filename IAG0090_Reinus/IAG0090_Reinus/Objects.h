...
typedef struct ob1
{ // formatting string for printf is "%s %lu %s\n", the result is for example "Abcde 100 15:52:30"
  // or "Abcde Fghij 100 15:52:30"
	char *pID;
...
typedef struct ob2
{  // formatting string for printf is "%s %lu %02d:%02d:%02d\n", the result is for example "Abcde 100 15:52:07"
   // or "Abcde Fghij 100 15:52:07"	
	char *pID;
	unsigned long int Code;
...
typedef struct ob4
{  // formatting string for printf is "%s %lu %s\n", the result is for example "Abcde 100 10-15-2010"
   // or "Abcde Fghij 100 10-15-2010"
	char *pID;
	unsigned long int Code;
...
typedef struct ob5
{  // formatting string for printf is "%s %lu %02d-%02d-%04d\n", the result is for example "Abcde 100 01-12-2010"
   // or "Abcde Fghij 100 01-12-2010"
	char *pID;
	unsigned long int Code;
...
typedef struct ob7
{  // formatting string for printf is "%s %lu %02d %s %04d\n", the result is for example "Abcde 100 01 Dec 2010"
   // or "Abcde Fghij 100 01 Dec 2010"
	char *pID;
	unsigned long int Code;
...
typedef struct ob9
{  // formatting string for printf is "%s %lu %02d %s %04d\n", the result is for example "Abcde 100 01 Detsember 2010"
